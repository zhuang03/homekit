...
#define i2c_write   mpu.MPU_Write_Len
#define i2c_read    mpu.MPU_Read_Len
...
//	LOG_P("accel_result:%d",accel_result);
    gyro_result = gyro_self_test(gyro, gyro_st);
//    LOG_P("gyro_result:%d",gyro_result);
...
//返回值:0,正常
//    其他,失败
uint8_t InvMpu::mpu_dmp_init(void)
{
	// uint8_t res=0;
...
//返回值:0,正常
//    其他,失败
uint8_t InvMpu::mpu_dmp_get_data(float *pitch,float *roll,float *yaw)
{
